    ...
    <div className="space-y-6">
      ...
      <div className="pb-4 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Pengaturan identitas sekolah yang tersinkronisasi otomatis untuk kop surat, cetak KTS, dan rekapitulasi absensi.
          </p>
        </div>
      ...
      {savedSuccess && (
        <div className="p-3.5 bg-emerald-50 border border-emerald-300 rounded-xl flex items-center gap-2.5 text-emerald-900 text-xs shadow-xs animate-fadeIn">
          ...
          <span>
            <strong>Profil sekolah berhasil disimpan!</strong> Data kop surat dan cetak KTS kini telah diperbarui di semua perangkat.
          </span>
        </div>
      )}
      ...
      >
        <div className="border-b border-slate-100 pb-3 font-semibold text-sm text-slate-800">
